							...
							<div class="doctor-widget">
								<div class="doc-info-left">
									...
									<div class="doc-info-cont">
										...
										<p class="doc-speciality"> Phòng khám {{$doctor->profile->clinic_name}}</p>
										<p class="doc-department"><img src="{{ asset('assets/img/specialities/specialities-05.png') }}" class="img-fluid" alt="Speciality">
										@foreach ($doctor->proficiencies as $chuyenkhoa)
											{{ $chuyenkhoa->name }}
										@endforeach
										</p>
										<!-- <div class="rating">
										...
										<div class="clinic-details">
											<p class="doc-location"><i class="fas fa-map-marker-alt"></i> {{$doctor->profile->clinic_address}} <a href="javascript:void(0);">Get Directions</a></p>
								...
								<div class="doc-info-right">
									...
									<div class="clinic-booking">
										<a class="apt-btn" href="/booking/{{$slug}}">Đặt lịch khám</a>
									</div>
								</div>
							</div>
						</div>
						...
						<div class="card-body pt-0">
							...
							<nav class="user-tabs mb-4">
								<ul class="nav nav-tabs nav-tabs-bottom nav-justified">
									<li class="nav-item">
										<a class="nav-link active" href="#doc_overview" data-toggle="tab">Sơ lược</a>
									</li>
									<li class="nav-item">
									...
									<li class="nav-item">
										<a class="nav-link" href="#doc_business_hours" data-toggle="tab">Các khung giờ khám</a>
									</li>
								</ul>
							</nav>
							<!-- /Tab Menu -->
									...
									<div class="row">
										<div class="col-md-12 col-lg-9">
													...
													<ul class="experience-list">
														<li>
															...
															<div class="experience-content">
																<div class="timeline-content">
																	...
																	<div>{{$doctor->profile->education}}</div>
														...
														<li>
															...
															<div class="experience-content">
																<div class="timeline-content">
																	<!-- <a href="#/" class="name">American Dental Medical University</a> -->
																	<div>{{$doctor->profile->experience}}</div>
											...
											<div class="widget experience-widget">
												<h4 class="widget-title">Kinh nghiệm</h4>
												<div class="experience-box">
													<ul class="experience-list">
														<li>
															<div class="experience-user">
															...
															<div class="experience-content">
																<div class="timeline-content">
																	...
																	<span class="time">{{$doctor->profile->experience}}</span>
																</div>
															</div>
														</li>
											...
											<div class="widget awards-widget">
												<h4 class="widget-title">Các giải thưởng</h4>
												<div class="experience-box">
													<ul class="experience-list">
														<li>
															<div class="experience-user">
